        ...
        <section id="hero" class="hero hero-convenios section accent-background">
            ...
            <div class="container position-relative"  data-aos-delay="100">
                ...
                <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-right">
                    <h2>Empréstimo Consignado para Servidores do <span>Governo Federal</span></h2>
                    <p>Crédito rápido, seguro e com as melhores taxas para quem é servidor do Governo Federal.</p>
                    <div class="d-flex">
                ...
                <div class="col-lg-7 order-1 order-lg-2" data-aos="fade-left">
                    <img src="<?php echo BASE_URL; ?>assets/img/convenios/governo-federal.svg" class="img-fluid" alt="">
                </div>
                </div>
            </div>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-7 d-flex flex-column align-items-center text-center" data-aos="fade-up" data-aos-delay="200">
                        <div class="sobre-consignado-container d-flex flex-column align-items-center text-start">
                            <img src="<?php echo BASE_URL; ?>assets/img/convenios/servidor-governo-federal.jpg" class="img-fluid" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5" data-aos="fade-up" data-aos-delay="50">
                        <div class="content ">
                            ...
                            <h4>O crédito consignado para servidores públicos federais é uma modalidade de empréstimo destinada a funcionários ativos, inativos e pensionistas do Governo Federal, em que as parcelas são descontadas diretamente da folha de pagamento ou do benefício recebido mensalmente.</h4>
                        </div>
                    </div>
